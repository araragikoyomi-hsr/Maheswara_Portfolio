    ...
    <section className="flex flex-col lg:flex-row h-full p-6 items-center min-h-[70vh]">
      ...
      >
        ...
        <p className="text-center md:text-start text-xs md:text-base">
          I’m a Software Developer with hands-on experience in building scalable
          cross-platform applications using React Native (Expo), NestJS, and
          Electron.js. Previously worked as an SDE-1 at Salesken.ai, where I
          developed mobile and desktop apps, optimized performance, and
          integrated real-time communication features. Skilled in TypeScript,
          JavaScript, and modern frameworks like Next.js and Tailwind CSS, I’m
          passionate about creating efficient, user-friendly solutions.
        </p>
        <Link to="./Maheswara_resume.pdf" target="_blank">
          <motion.div
      ...
      >
        <motion.img
          ...
          src="/Maheswara_image.jpg"
          alt="profile"
          width="100%"
          height="100%"
        />
      </motion.div>
      <LeaveCard label="Mobile App Dev" />
    </section>
  );
};
